...
Contributors: Ricky Dawn, Sean Dawn, Web Results Direct
License: GPLv3
...
Q: I am still seeing spam traffic showing in Analytics
A: Watch the video within the plugins settings page - to block 100% of the spam traffic it is a 2 step process

Q: Can I see the full list of blocked sites?
A: Yes go here: http://botblock.rickydawn.com/block_list.php

Q: Something has gone wrong and my site isn't working
A: Disable the plugin, if you cannot get into your admin area delete the plugin files via FTP. Then drop us a message on the support page.
